...
import { DEVELOPMENT_MODE, SONIC_ENDPOINT, SONIC_PROD_ENDPOINT, SONIC_TVE_REALM, USE_REALM_SERVICE, AUTH_DOMAIN, AUTH_PROD_DOMAIN, } from "../env";
import * as M from "@discovery/prelude/lib/data/maybe";
import { SiteLookupKey } from "../constants";
const useConfig = DEVELOPMENT_MODE === false || USE_REALM_SERVICE;
const productToSiteLookupKey = (product = process.env.PRODUCT) => product && product in SiteLookupKey ? M.of(product) : M.empty();
...
const staticRealmApp = App.of(staticRealmConfig);
