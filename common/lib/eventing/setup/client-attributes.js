 ...
 */
const getClientAttributes = (eventTracker) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    ...
    return {
        ...
        limitAdTracking,
        connectionType: (_c = (_b = navigator.connection) === null || _b === void 0 ? void 0 : _b.type) !== null && _c !== void 0 ? _c : EventsLib.ConnectionTypes.UNKNOWN,
    };
});
