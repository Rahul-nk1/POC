...
import { mkPaginated, mkPaginatedComponent, mkPaginatedCollection, } from "@discovery/orchestra/lib/pagination";
...
export const useSonicHttp = mkSonicHttp(Object.assign(Object.assign({}, baseHooks), { useRealmConfig }))(Object.assign(Object.assign({}, envBrowser), { sonicApiConfig: {
...
export const { useCallback, useContext, useEffect, useMemo, useRef, useState, } = baseHooks;
export const usePaginatedCollection = mkPaginatedCollection(Object.assign(Object.assign({}, baseHooks), { useSonicHttp }))();
export const usePaginated = mkPaginated(Object.assign(Object.assign({}, baseHooks), { usePaginatedCollection }))();
...
export const { useHistory } = mkHistory(baseHooks)(Object.assign({}, history()));
export const { useWhenInView, useInView } = mkInView(baseHooks)({
    observer: window.IntersectionObserver,
});
export const { updateGlobalState, useGlobalState, useGlobalStateModifier, } = mkGlobalState(baseHooks)({
    initialState,
});
export const useStorage = mkStorage(baseHooks)(Object.assign(Object.assign({}, storage), json));
