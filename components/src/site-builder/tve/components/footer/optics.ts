...
export const _LegalLinkProps = Fold.liftM(
  (href, data) => ({
    href,
    title: O.getOrElse(() => "")(data.attributes.title),
...
export const _SocialLinkPops = Fold.liftM(
  (iconDefaultM, iconAlternateM, href, data) => ({
    ...
    iconMobileM: O.alt(() => iconDefaultM)(iconAlternateM),
    iconDesktopM: O.alt(() => iconAlternateM)(iconDefaultM),
    href,
    title: O.getOrElse(() => "")(data.attributes.title),
    kind: kind2kind(data.attributes.kind)
  }),
...
export const _IconLinkItems = Fold.compose(_ExtractFooterSocail, _SocialLinkPops)
export const _CopyRightsItem = Fold.compose(_ExtractFooterCopyRights, _ColAttributes2Title)
